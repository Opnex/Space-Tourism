<template>
  <div class="destinations-page">
    ...
    <div class="background-image">
      <img src="/public/img/background-destination-desktop.jpg" alt="Space Background" />
    </div>
        ...
        <div class="col-lg-6">
          <nav class="destination-tabs">
            <button
              ...
              :key="index"
              @click="setCurrentDestination(dest)"
          ...
          <div class="destination-info">
            ...
            <div class="destination-stats">
              ...
              <div>
                ...
                <strong>{{ currentDestination.travelTime }}</strong>
              </div>
            </div>
          </div>
        </div>
  ...
  data() {
    return {
      ...
      destinations: [
        {
          name: "MOON",
          image: ("/public/img/image-moon.png"),
        ...
        {
          name: "MARS",
          image: ("/public/img/image-mars.png"),
        ...
        {
          name: "EUROPA",
          image: ("/public/img/image-europa.png"),
        ...
        {
          name: "TITAN",
          image: ("/public/img/image-titan.png"),
